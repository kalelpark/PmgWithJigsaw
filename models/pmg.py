...
class BasicConv(nn.Module):
    def __init__(self, inplanes, out_planes, kernel_size, stride = 1, padding = 0, dilation = 1, groups = 1, relu = True, bn = True, bias = False):
        super(BasicConv, self).__init__()
        self.out_channels = out_planes
        self.conv = nn.Conv2d(  inplanes, out_planes, kernel_size = kernel_size,
